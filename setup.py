...
setup(
  ...
  author = 'Ira Nathan',                   # Type in your name
  author_email = 'your.email@domain.com',      # Type in your E-Mail
  url = 'https://github.com/iranathan/teverse.py',   # Provide either the link to your github or to your website
  keywords = ['teverse'],   # Keywords that define your package best
